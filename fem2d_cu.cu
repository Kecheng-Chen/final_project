...
//
    ...
    for ( k = 1; k <= n-1; k++ )
    {
        ...
        check_pivot<<<dimGrid , dimBlock>>>(a_d,column_d,k,col);
        ...
        if(l!=mm){
            Kernel_1<<<dimGrid , dimBlock>>>(a_d,l,mm,k,ju,k,col);
        }
